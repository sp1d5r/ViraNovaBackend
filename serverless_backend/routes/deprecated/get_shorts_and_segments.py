...
from serverless_backend.database.production_database import ProductionDatabase
from qdrant_client import QdrantClient, models

get_shorts_and_segments = Blueprint("get_shorts_and_segments", __name__)

@get_shorts_and_segments.route("/v2/get-random-short-video", methods=['GET'])
...
@get_shorts_and_segments.route("/v2/get-short-and-segments", methods=['GET'])
