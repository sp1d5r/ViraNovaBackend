import numpy as np
from serverless_backend.services.segmentation_loader import load_video_data
...
@get_segmentation_mask.route("/load-segmentation-from-file/<video_file>", methods=['GET'])
