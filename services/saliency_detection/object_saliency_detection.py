...
class ObjectSaliencyDetector(VideoSaliencyDetector):
    ...
    def calculate_saliency(self, frame):
        ...
        saliency.setTrainingPath('/Users/elijahahmad/PycharmProjects/ViraNovaBackend/services/saliency_detection/pre-trained-models')
